...
For the purposes of the post, we will be building out a basic e-commerce application.
...
You fetch save the messages locally or fetch them from a remote source depending on your workflow.

At the root of your project, create messages folder where you can create JSON files for each locale like below.
